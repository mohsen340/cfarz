...
class Telegram {
    ...
    */
    ...
    public function InlineQuery_ChatID() {
        return $this->data['update_id']['from']['id'];
    }
	
    public function Callback_FromChatID() {
        return $this->data["callback_query"]["from"]["id"];
    }
    public function InlineQuery_FromChatID() {
...
/// Get the number of updates
     ...
     * \return the requested keyboard as Json
     */
    public function buildInlineKeyBoard(array $options, $json=1) {
        $replyMarkup = array(
            'inline_keyboard' => $options,
        );
		if($json==0)return $replyMarkup;
        $encodedMarkup = json_encode($replyMarkup, true);
        return $encodedMarkup;
    }
