        ...
        <div class="col-md-12">
            <div class="portlet box border shadow round">
                ...
                <div class="portlet-body">
                    <div class="portlet-body">
                        <form role="form" action="InsertNewCoin" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-body">
                                <div class="form-group">

                                    <div class="form-group">
                                        <label>عنوان سکه </label>
                                        <div class="input-group round">
                                                <span class="input-group-addon">
                                                    <i class="icon-info"></i>
                                                </span>
                                            <input type="text" name="name" class="form-control" value="" placeholder="نام سکه وارد شود">
                                        </div><!-- /.input-group -->
                                    </div><!-- /.form-group -->
                                    ...
                                    <div class="form-group">
                                        <label>نمایش سکه در اپلیکیشن</label>
                                        <div class="input-group round">
                                                <span class="input-group-addon">
                                                    <i class="icon-settings"></i>
                                                </span>
