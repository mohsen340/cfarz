        ...
        <div class="col-md-12">
            <div class="portlet box border shadow round">
                ...
                <div class="portlet-body">
                    <div class="portlet-body">
                        <form role="form" action="InsertNewMobileBrand" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group round">
                                            ...
                                            <input type="text" name="name" class="form-control" value="" placeholder="نام برند وارد شود">
                                        </div><!-- /.input-group -->
                                    </div><!-- /.form-group -->
