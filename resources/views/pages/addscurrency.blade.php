        ...
        <div class="col-md-12">
            <div class="portlet box border shadow round">
                ...
                <div class="portlet-body">
                    <div class="portlet-body">
                        <form role="form" action="InsertNewSCurrency" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-body">
                                ...
                                <table class="table table-condensed table-hover table-striped" id="data-table">
                                    ...
                                    @foreach($currencyList as $currency)
                                        <tr>
                                            <?php $i++;?>
                                            <td><?php echo $i;?></td>
                                           <td><img src="{{$currency->filename}}" height="35"  class="img-rounded float-right" alt="{{$currency->name}}"></td>
