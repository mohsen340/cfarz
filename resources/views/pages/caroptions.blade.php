        ...
        <div class="col-md-12">
            <div class="portlet box border shadow round">
                ...
                <div class="portlet-body">
                    <div class="portlet-body">
                        <form role="form" action="InsertNewCarOption" method="post">
                            {{csrf_field()}}
                            <div class="form-body">
