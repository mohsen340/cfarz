        ...
        <div class="col-md-12">
            <div class="portlet box border shadow round">
                ...
                <div class="portlet-body">
                    <div class="portlet-body">
                        <form role="form" action="InsertNewCurrency" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group round">
                                            ...
                                            <input type="text" name="name" class="form-control" value="" placeholder="نام ارز وارد شود">
                                        </div><!-- /.input-group -->
                                    </div><!-- /.form-group -->
                                    ...
                                    <div class="form-group">
                                        <label>نمایش ارز در اپلیکیشن</label>
                                        <div class="input-group round">
                                                <span class="input-group-addon">
                                                    <i class="icon-settings"></i>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <label>نمایش در مرتبط با ارز</label>
                                        <div class="input-group round">
                                                <span class="input-group-addon">
                                                    <i class="icon-settings"></i>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group round">
                                            ...
                                            <input class="form-control" type="number" placeholder="اولویت نمایش وارد شود" name="priority">
                                        </div><!-- /.input-group -->
                                    </div><!-- /.form-group -->
                                    ...
                                    @foreach($currencyList as $currency)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <select name="status"  onchange="saveToDatabaseThree(this,'connected_id','{{$currency->id}}')">
                                                        @if($currency->connected_id==0)
                                                            <option value="0" selected>هیچکدام</option>
                                                            @foreach($currencyList as $currency)
                                                                <option value="{{$currency->id}}" >{{$currency->name}}</option>
                                                            @endforeach
                                                        @else
                                                            <option value="0">هیچکدام</option>
                                                                ...
                                                                @if($currency->connected_id==$currency->id)
